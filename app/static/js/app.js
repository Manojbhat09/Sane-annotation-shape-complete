...
function App() {
    ...
    this.push_box_frames = function(fname){
        ...
        $("#loading-screen").show();
        if(selectedBox){
            console.log("Boxes selected are");
            ...
            $.ajax({
                ...
                data: JSON.stringify({
                    fname: fname,
                    // bounding_boxes: stringifyBoundingBoxes2(app.cur_frame.bounding_boxes)
                    bounding_boxes: stringifyBoundingBoxes2([selectedBox])
                }),
                type: 'POST',
                contentType: 'application/json;charset=UTF-8',
                success: function(response) {
                    console.log("success on pcn")
                    ...
                    // generatePointCloudSubset(data, COLOR_RED, false);
                    app.completion_data = data;
                    generatePointCloudSubset(data, COLOR_RED, 3, "RLGAN_points", false);
